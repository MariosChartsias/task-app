...
/**
 * Filter that intercepts all requests to validate JWT tokens. Requests without
 * valid tokens will be rejected except for login and register endpoints.
 */
@Component
public class JwtFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (username == null) {
			...
			// Ορισμός του authentication context
